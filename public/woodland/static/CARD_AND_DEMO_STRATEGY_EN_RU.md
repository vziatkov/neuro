...
**Parallax (gyro)**  
Offset L1 / L2 / L3 with different coefficients on device tilt → “aquarium” depth on a flat card.
...
**Параллакс (гироскоп)**  
Разные коэффициенты сдвига для L1/L2/L3 при наклоне устройства — ощущение «аквариума».
...
*Version 1.0 · for local Cursor context · `public/woodland/static/`*
